...
PHONES = ["+225 27 23 29 71 54", "+225 07 59 63 39 54", "+225 05 76 22 52 16"]
...
SERVICES = [
    {
        ...
        "title": "Câblage réseaux informatique et téléphonique",
        "icon": "cable",
    ...
    },
    {
        ...
        "problem": "Vos sites sont éloignés, votre réseau fibre est saturé ou vous devez raccorder de nouveaux clients rapidement, sans interrompre le service existant.",
    ...
    {
        "id": "reseau-ip-wifi",
        "short": "Réseau IP et sans fil",
        "title": "Réseau IP et sans fil",
        "icon": "wifi",
...
CLIENTS = [
    ...
    ("fidra", "FiDRA", "Retraite et prévoyance"),
    ("bouygues", "Bouygues Énergies & Services", "Énergie et services"),
    ...
    ("ofi", "OFI", "Négoce et agro-industrie"),
]
...
APPROACH = [
    ...
    ("02", "Conseil et étude", "Nous concevons la solution adaptée à votre contexte : réseau, fibre, énergie, sécurité ou télémétrie."),
...
WHY_US = [
    ("layers", "Une expertise multi-domaines intégrée", "Réseau, fibre optique, énergie, sécurité, data center et télémétrie : un seul interlocuteur pour l'ensemble de votre infrastructure technique."),
...
<header data-header class="group fixed inset-x-0 top-0 z-50 transition-all duration-300">
  ...
  <div class="container">
    <div class="flex h-24 items-center justify-between sm:h-28">
      <a href="index.html" class="flex items-center gap-2.5 shrink-0" aria-label="Retour à l'accueil FIRST-COM GROUP">
...
HERO_SLIDES = [
    ("images/hero/hero-datacenter.webp", "Baie de serveurs et infrastructure réseau supervisées par FIRST-COM GROUP"),
    ("images/realisations/cablage-reseau-intervention.webp", "Technicien FIRST-COM GROUP en intervention de câblage réseau"),
    ("images/realisations/fibre-optique-baie.webp", "Baie de brassage fibre optique installée par FIRST-COM GROUP"),
    ("images/realisations/reseau-ip-wifi-antenne.webp", "Installation d'un point d'accès réseau IP et Wi-Fi par FIRST-COM GROUP"),
    ("images/realisations/securite-cctv-installation.webp", "Installation d'un système de vidéosurveillance par FIRST-COM GROUP"),
]


def hero_slides_html():
    slides = []
    for i, (src, alt) in enumerate(HERO_SLIDES):
        active = " is-active" if i == 0 else ""
        first_attrs = 'fetchpriority="high"' if i == 0 else 'loading="lazy"'
        slides.append(
            '<img src="{src}" alt="{alt}" data-hero-slide class="hero-slide{active} absolute inset-0 h-[420px] w-full object-cover sm:h-[480px]" {attrs} width="666" height="973" />'.format(
                src=src, alt=alt, active=active, attrs=first_attrs
            )
        )
    return "\n            ".join(slides)
...
<section class="relative overflow-hidden bg-navy-gradient-light pb-24 pt-40 sm:pb-32 sm:pt-48">
  ...
  <div class="container relative grid grid-cols-1 items-center gap-16 lg:grid-cols-12 lg:gap-8">
    <div class="order-2 lg:order-1 lg:col-span-7">
      <p data-hero-eyebrow class="eyebrow">FIRST-COM GROUP</p>
      ...
      <p data-hero-sub class="mt-7 max-w-xl text-lg leading-relaxed text-ink-500">
        Câblage réseau, fibre optique, data center, énergie, sécurité électronique, supervision et télémétrie :
    ...
    <div class="order-1 lg:order-2 lg:col-span-5">
      <div data-hero-visual class="relative mx-auto max-w-md lg:max-w-none">
        <div data-hero-parallax class="relative">
          <div data-hero-slideshow class="relative h-[420px] w-full overflow-hidden rounded-[1.75rem] shadow-glow ring-1 ring-ink-100 sm:h-[480px]">
            """ + hero_slides_html() + """
  ...
  <div class="container grid grid-cols-1 items-center gap-14 lg:grid-cols-12">
    ...
    <div class="lg:col-span-7">
      ...
      <p data-reveal class="mt-4 max-w-xl text-ink-500 leading-relaxed">
        ...
        d'installer la solution adaptée, avec un accompagnement de proximité, du premier diagnostic à la
...
def home_approach():
    ...
    for i, (num, title, desc) in enumerate(APPROACH):
        steps.append("""
        <div data-reveal class="flex flex-col items-start lg:items-center lg:text-center">
          <span class="font-display text-2xl font-bold text-brick-500">{num}</span>
          <h3 class="mt-3 font-display text-base font-semibold text-navy-900">{title}</h3>
...
<section class="section bg-navy-50/40 relative overflow-hidden">
  ...
  <div class="container relative">
    ...
    <div class="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      {steps}
    </div>
  </div>
</section>
...
TEAM_ROLES = [
    ("cable", "Techniciens câblage et réseau", "Déploiement du câblage informatique, téléphonique et des réseaux IP/Wi-Fi sur site."),
...
PROJECT_DELIVERABLES = [
    ...
    ("check-badge", "Recette et mise en service", "Tests et validation de chaque équipement avant la mise en production."),
...
def build_about():
    values = [
        ("layers", "Expertise multi-domaines", "Réseau, fibre, énergie, sécurité, data center, télémétrie : nous réunissons ces compétences pour simplifier votre quotidien."),
        ("check-badge", "Rigueur et méthode", "Étude, déploiement, configuration, accompagnement : chaque projet suit un processus structuré, du premier échange à la mise en service."),
  ...
  <div class="container grid grid-cols-1 gap-14 lg:grid-cols-12 lg:gap-10">
    <div class="lg:col-span-6">
      ...
      <p data-reveal class="mt-5 leading-relaxed text-ink-500">
        Nous concevons et installons des solutions adaptées à votre environnement (réseau informatique et
        téléphonique, fibre optique, énergie, sécurité électronique, data center ou télémétrie), avec un
      ...
      <p data-reveal class="mt-4 leading-relaxed text-ink-500">
        ...
        réelles (continuité de service, sécurité de vos sites, fiabilité de vos réseaux) pour construire
    ...
    <div class="lg:col-span-6">
      ...
      <p data-reveal class="mt-4 leading-relaxed text-ink-500">
        Nous travaillons avec des marques reconnues internationalement (HIKVISION, Schneider Electric,
        Legrand, VIAVI, EXFO et nos autres partenaires technologiques) pour garantir la fiabilité de chaque
        installation.
      </p>
    </div>
  </div>
...
<section class="section">
  <div class="container grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
    ...
    <div class="lg:col-span-7">
      ...
      <p data-reveal class="mt-5 leading-relaxed text-ink-500">
        Pour chaque installation de câblage, de fibre, d'énergie ou de sécurité, nos équipes techniques se
        déplacent sur site pour étudier, déployer et configurer vos équipements, puis assurer le suivi dans la
        durée. Selon la nature du projet, nous mobilisons en interne les compétences qu'il faut&nbsp;:
      </p>
...
""".format(
        ...
        todo=todo_note(
            "Présentation nominative de l'équipe dirigeante (photos et bios), à intégrer par "
  ...
  <div class="container grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-14">
    <div class="lg:col-span-6 {img_order}">
      <div data-reveal class="relative overflow-hidden rounded-[1.75rem] shadow-card ring-1 ring-ink-100">
        <img src="{image}" alt="{title} par FIRST-COM GROUP" class="h-[340px] w-full object-cover sm:h-[400px]" loading="lazy" />
...
""".format(subnav=subnav_items, blocks=blocks_html, arrow=icon("arrow-right", "w-4 h-4"), phone_tel=PHONES_TEL[0], phone=PHONES[0], phone_icon=icon("phone", "w-4 h-4"))
    ...
    return page(
        ...
        description="Câblage réseau, fibre optique, réseau IP et Wi-Fi, data center, énergie, supervision fibre, télémétrie et sécurité : découvrez nos solutions en détail.",
        path="services.html",
        body=body,
    )
...
<section class="section bg-navy-50/40">
  <div class="container">
    <div class="mx-auto max-w-2xl text-center">
      ...
      <p data-reveal class="mt-4 text-ink-500 leading-relaxed">
        Que le projet concerne le réseau, la fibre, l'énergie ou la sécurité, il suit le même
...
""".format(
        ...
        todo=todo_note(
            "Études de cas détaillées par projet (contexte, solution déployée, photos du chantier), à "
    ...
    return page(
        title="Références et partenaires | FIRST-COM GROUP",
...
<section class="section bg-navy-50/40">
  <div class="container">
    <div class="mx-auto max-w-2xl text-center">
      ...
      <h2 data-reveal class="mt-4 text-display-md font-bold text-balance">Avant / après et vidéos d'intervention</h2>
    </div>
...
def build_contact():
    ...
    faq = [
        ...
        ("Proposez-vous un accompagnement après l'installation ?", "Oui : selon les domaines (fibre, télémétrie, réseaux), nous proposons des solutions de supervision et de suivi continu, avec alertes en cas d'anomalie."),
    ...
    <div class="lg:col-span-5">
      <div class="space-y-5">
        ...
        <div data-reveal class="overflow-hidden rounded-2xl shadow-card ring-1 ring-ink-100">
          <iframe
            title="Localisation de FIRST-COM GROUP à Attécoubé, Abidjan"
...
def build_home():
    ...
    return page(
        title="FIRST-COM GROUP | Réseaux, fibre optique, énergie et sécurité à Abidjan",
