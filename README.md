...
- La liste des 18 références clients et des 10 partenaires technologiques (logos extraits
...
- Les titres de section, les textes d'accroche, la mise en récit « contexte client / notre
  ...
  MTN = télécoms, FAO/UNEP = agences onusiennes, etc.), la présentation par métiers
...
- Les chiffres affichés (18 références, 10 partenaires) sont des **comptages réels** des
  éléments de la plaquette.
- À votre demande, le logo UNFPA a été retiré de la liste des références (le fichier fourni
  s'affichait mal) ; le bloc « Chiffres clés » (années d'expérience / projets réalisés /
  partenaires) a également été retiré de la page d'accueil.
