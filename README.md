...
projets.html             Réalisation : galerie photos/vidéos des chantiers et interventions
...
## Ajouter une vraie réalisation sur la page « Réalisation »

La page `projets.html` (onglet « Réalisation » du menu) affiche pour l'instant une galerie
d'illustrations de vos domaines d'intervention, en attendant vos vraies photos de chantier.
Pour publier un projet réel, ouvrez `build.py`, cherchez la liste `PROJECTS = []` (juste avant
la fonction `build_realisation_gallery`) et ajoutez un élément sur ce modèle :
...
Placez vos photos dans un dossier `images/realisations/` (à créer), puis régénérez le site
(commandes ci-dessus). Dès qu'un projet est ajouté à cette liste, la galerie d'illustrations
générique disparaît automatiquement au profit de vos vraies réalisations.
...
- Les chiffres affichés (19+ références, 10 partenaires) sont des **comptages réels** des
  éléments de la plaquette.

**⚠️ Chiffre à confirmer par vos soins**
- La section « Chiffres clés » de la page d'accueil affiche désormais **8+ années
  d'expérience**, **50+ projets réalisés** et **10+ partenaires technologiques** (ce dernier
  correspond au comptage réel des partenaires listés dans la plaquette). Les deux premiers
  chiffres (8+ et 50+) reprennent l'exemple que vous avez donné dans vos retours — merci de
  nous confirmer qu'il s'agit bien des chiffres réels de l'entreprise avant la mise en ligne
  définitive, ou de nous transmettre les valeurs exactes si elles diffèrent.
...
- Page « Réalisation » (nouvel onglet) : galerie de vraies photos de chantier, avant/après et
  vidéos d'intervention — en attendant vos fichiers, la page affiche une galerie illustrant
  vos domaines d'intervention avec les mêmes photos que la page Services
