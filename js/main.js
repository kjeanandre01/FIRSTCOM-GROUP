...
(function () {
  ...
  // Filet de sécurité : si un élément n'a jamais été révélé (bug de calcul de
  // position, layout qui change après chargement des images, etc.), on force
  // son affichage après un court délai plutôt que de laisser un bloc de texte
  ...
  /* ---------------------------------------------------------------------
     5bis. Diaporama du visuel d'accueil (plusieurs photos d'activités)
  --------------------------------------------------------------------- */
  ...
  /* ---------------------------------------------------------------------
     12. Slider secteurs d'activité (accueil)
  --------------------------------------------------------------------- */
  document.querySelectorAll("[data-slider]").forEach(function (slider) {
    ...
    function step() {
      ...
      return card ? card.getBoundingClientRect().width + 20 : track.clientWidth * 0.85;
    }
    function updateButtons() {
      var max = track.scrollWidth - track.clientWidth - 4;
      if (prev) prev.disabled = track.scrollLeft <= 4;
      if (next) next.disabled = track.scrollLeft >= max;
      if (prev) prev.classList.toggle("opacity-30", track.scrollLeft <= 4);
      if (next) next.classList.toggle("opacity-30", track.scrollLeft >= max);
    }
